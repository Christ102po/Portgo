...
const LABELS = { motorcycle: "Motorcycle", car: "Car / Van", cargo: "Cargo", other: "Other" };
const COLORS = ["#18251D", "#3F5747", "#B7FF72", "#94A3B8"];

export function VehicleSummaryChart({ breakdown }) {
  ...
  if (total === 0) {
    return (
      <div className="flex h-[220px] items-center justify-center text-sm text-slate-400">
        No vehicle bookings for this period.
      </div>
    );
  }
